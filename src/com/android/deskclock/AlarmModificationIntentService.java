...
import mokee.alarmclock.MoKeeAlarmClock;
...
public class AlarmModificationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (MoKeeAlarmClock.ACTION_SET_ALARM_ENABLED.equals(action)) {
            long alarmId = intent.getLongExtra(MoKeeAlarmClock.EXTRA_ALARM_ID, -1L);
            boolean enabled = intent.getBooleanExtra(MoKeeAlarmClock.EXTRA_ENABLED, true);
            if (alarmId != -1L) {
